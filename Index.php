...
<body>
  <header>
    <div class="logo"><a href="#">@Brayoh_ule_musee Shop</a></div>
    <div class="menu">
      <a href="#">
      ...
      <div class="section2">
        <div class="container">
          <div class="items">
            ...
            <div class="info">Shoes that are durable</div>
          </div>
          <div class="items">
            ...
            <div class="info">Non fading T-shirts.</div>
          </div>
          <div class="items">
            ...
            <div class="info">Soft jeans accessible</div>
          </div>
          <div class="items">
            ...
            <div class="info">Smart watches very durable</div>
          </div>
          <div class="items">
            ...
            <div class="info">All types of phone available</div>
          </div>
          <div class="items">
            ...
            <div class="info">smart tvs available</div>
          </div>
          <div class="items">
            ...
            <div class="info">All types Available.</div>
          </div>
          <div class="items">
            ...
            <div class="info">Shop with us today</div>
          </div>
          <div class="items">
          ...
          <div class="items">
            ...
            <div class="info">All brands Available.</div>
          </div>
          <div class="items">
            ...
            <div class="info">Epliciting brands.</div>
          </div>
          <div class="items">
          ...
          <div class="items">
            ...
            <div class="info">const close = document.querySelector(".close");
...
open.addEventListener("click", () => {
  ...
  <footer>
    <div class="footer0">
      <h1>Brayo_ule_musee</h1>
    </div>
    <div class="footer1 ">
      Connect with us at<div class="social-media">
        <a href="https://www.facebook.com/brian.mutwiri.9404">
    ...
    <div class="footer3">Copyright © <h4>@brayoh_ule musee</h4> 2023</div>
  </footer>
